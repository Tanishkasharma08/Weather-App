...
Replace the API key in weather_app.py with your OpenWeatherMap API key:
api_key = "795d0d22cf67b728e9f884e11eab217b"
Run the application:
python weather_app.py
Enter a city name in the app and click Search or press Enter
...
Building and documenting a beginner-friendly Python project
Practicing full-stack development fundamentals with API integration
